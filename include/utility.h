...
enum class SensorType { VELODYNE, OUSTER, LIVOX, PANDAR };
...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/trajectory_path", trajectory_path, "/home/quintinumi/git_package_src/ws_LIO_SAM/src/LIO-SAM/data/20250226_route1.txt");
